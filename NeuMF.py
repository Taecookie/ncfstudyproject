...
# 중요: 같은 폴더에 있는 GMF_TF2.py와 MLP_TF2.py를 불러옵니다.
import GMF_TF2 as GMF
import MLP_TF2 as MLP
...
if __name__ == '__main__':
    ...
    mf_pretrain = 'Pretrain/GMF_weights.h5'
    mlp_pretrain = 'Pretrain/MLP_weights.h5'
